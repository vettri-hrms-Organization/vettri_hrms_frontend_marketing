...
export function ProductPreview({ variant = "command" }: { variant?: Variant }) {
  if (variant === "employee") {
    return (
      <div className="interface employee-preview">
        <div className="interface-header"><strong>My Vettri</strong><span className="status">Vettri workspace</span></div>
  ...
  if (variant === "software") {
    return (
      <div className="interface software-preview">
        <div className="interface-header"><strong>Software catalog</strong><span className="status">Connected workflow</span></div>
        ...
        <div className="software-item"><Laptop size={18} color="var(--blue)" /><div><b>Workspace tools</b><small>Assigned device · deployment ready</small></div><span className="list-state">Ready to review</span></div>
      </div>
    );
  }
  ...
  if (variant === "assets") {
    return (
      <div className="interface">
        <div className="interface-header"><strong>Assets &amp; devices</strong><span className="status">Vettri workspace</span></div>
  ...
  if (variant === "hr") {
    return (
      <div className="interface">
        <div className="interface-header"><strong>People operations</strong><span className="status">Vettri workspace</span></div>
  ...
  return (
    <div className="interface">
      <div className="interface-header"><strong>Workplace command center</strong><span className="status">Vettri workspace</span></div>
      <div className="profile-row"><Activity size={18} color="var(--blue)" /><div><b>See the work behind the work</b><small>Connected operational view</small></div></div>
    </div>
  );
}
