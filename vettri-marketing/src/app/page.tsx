...
import {
  ArrowRight, Check, CheckCircle2, ChevronRight, Cloud,
...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Vettri HRMS is a modern HR management platform that helps businesses manage employee records, attendance, leave, payroll context and everyday workplace operations.",
  path: "/",
  imageAlt: "Vettri HRMS workplace management platform",
});
...
export default function Home() {
  return <>
    <Navbar />
    <main id="main-content" className="v4-home">
      <section className="v4-hero">
        <div className="v4-grid-glow" />
        <div className="container">
          <div className="v4-hero-copy">
            <Reveal><span className="v4-eyebrow"><i/>THE CONNECTED WORKPLACE PLATFORM</span></Reveal>
            <Reveal delay={.06}><h1>Vettri HRMS for a <span>connected workplace.</span></h1></Reveal>
            <Reveal delay={.12}><p>Vettri HRMS connects employee records, attendance, leave, payroll context and workplace operations in one clear operating layer.</p></Reveal>
